...
exempt_routes=["/user/login", "/user/register","/user/verify-email","/user/reset-password" ,"/docs","/chat-bot/chat","/openapi.json","/files/fileUpload","/files/getFiles","/health","/chat-bot","/chat-bot/all"]
